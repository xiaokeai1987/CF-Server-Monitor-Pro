  ...
  async fetch(request, env, ctx) {
    ...
    const footerHtml = `
      <div style="text-align: center; margin-top: 40px; padding-bottom: 20px; font-size: 13px; color: inherit; opacity: 0.8;">
        Powered by <a href="https://github.com/xiaokeai1987/CF-Server-Monitor-Pro" target="_blank" style="color: #3b82f6; text-decoration: none; font-weight: 600;">CF-Server-Monitor-Pro</a>
      </div>
    `;
